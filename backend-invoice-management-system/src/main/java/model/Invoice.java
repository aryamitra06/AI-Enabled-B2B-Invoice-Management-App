...
public class Invoice {
	...
	//fetching all data
	public Invoice(int sl_no, String business_code, String cust_number, String clear_date, String buisness_year,
	...
	//adding data
	public Invoice(String business_code, String cust_number, String clear_date, String buisness_year,
			String doc_id, String posting_date, String document_create_date, String due_in_date,
			String invoice_currency, String document_type, String posting_id, String total_open_amount,
	...
	//editing data
	public Invoice(int sl_no, String invoice_currency, String cust_payment_terms) {
		super();
		this.sl_no = sl_no;
		this.invoice_currency = invoice_currency;
		this.cust_payment_terms = cust_payment_terms;
	...
	//adding aging bucket
	public Invoice(String aging_bucket, int sl_no) {
		super();
		this.sl_no = sl_no;
		this.aging_bucket = aging_bucket;
	}
